    ...
    public function Main()
    {
      ...
      ->orderBy('abouts.id', 'ASC')->get();
        ...
        if (\Request::route()->getName() == 'home') {
            $data['show_ads'] = '1';
        } elseif (\Request::route()->getName() == 'top_imdb') {
            $data['show_ads'] = '1';
        } elseif (\Request::route()->getName() == 'much_like') {
            $data['show_ads'] = '1';
        } elseif (\Request::route()->getName() == 'movie_year') {
            $data['show_ads'] = '1';
        } elseif (\Request::route()->getName() == 'movie_tag') {
            $data['show_ads'] = '1';
        } elseif (\Request::route()->getName() == 'category' || \Request::route()->getName() == 'playlist') {
            $data['show_ads'] = '1';
        } elseif (\Request::route()->getName() == 'movie') {
            $data['show_ads'] = '2';
        } elseif (\Request::route()->getName() == 'search') {
            $data['show_ads'] = '1';
        } elseif (\Request::route()->getName() == 'letters') {
            $data['show_ads'] = '1';
        } elseif (\Request::route()->getName() == 'letters_number') {
            $data['show_ads'] = '1';
        } elseif (\Request::route()->getName() == 'article' || \Request::route()->getName() == 'article.all') {
            $data['show_ads'] = '1';
        } else {
            $data['show_ads'] = '1';
        }
