...
<script src="{{ asset('minified/sceditor.min.js') }}"></script>
    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" enctype="multipart/form-data" action="{{ route('admin.article.update', ['id'=> $request->id]) }}" method="POST">
                                    {{ method_field('PUT') }}
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="description" id="example" rows="15" cols="150">{{ $request->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <button class="btn btn-success btn-lg" type="submit">แก้ไขบทความ</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
